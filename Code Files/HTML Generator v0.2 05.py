        ...
        if Row_Elements < Threshold:
            ...
            for element in range(len(Labels)):
                ...
                if Labels.loc[element, 'Boxname'] == Test_String:
                    ...
                    # Storing the HTML script
                    text = " " + str(label_String) + ' <input id="' + name_block2 + '" name="' + name_block + '" value="yes"' + ' type="checkbox" />' +' \n'
        
                    
            if label_String == "":
                # Storing the HTML script 
                text = " " + str(df.loc[row, 'Name']) + ' <input id="' + name_block2 + '" name="' + name_block + '" value="yes"' + ' type="checkbox" />' +' \n'
